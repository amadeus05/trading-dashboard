...
function normalizeMetrics(value: unknown): DashboardMetrics {
  ...
  return {
    ...
    wallet_balance: asNumber(source.wallet_balance, 0),
    realized_pnl: asNumber(source.realized_pnl, 0),
    ...
    closed_trades_count: asNumber(source.closed_trades_count, 0),
    ...
    total_trades: asNumber(source.total_trades, 0),
    longs_count: asNumber(source.longs_count, 0),
    shorts_count: asNumber(source.shorts_count, 0),
    filtered_realized_pnl: asNumber(source.filtered_realized_pnl, asNumber(source.realized_pnl, 0)),
    filtered_win_rate: asNumber(source.filtered_win_rate, asNumber(source.win_rate, 0)),
    filtered_trades_count: asNumber(source.filtered_trades_count, asNumber(source.closed_trades_count, 0)),
  };
}
